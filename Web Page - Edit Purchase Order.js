...
$(document).ready(function () {
    ...
    if(vpostatus == "100000002")
    {
      ...
      {
        $('#gsc_mmpcreceiptdate').siblings('.datetimepicker').children('.form-control').removeAttr("readonly");
        $('#gsc_mmpcreceiptdate').siblings('.datetimepicker').children('.input-group-addon').show();
      }
    }
    ...
    function filterApproval(approverSetupId) {
        ...
        $.ajax({
            ...
            success: function (approver) {
              var userApproverLevel = parseInt(approver.value[0].gsc_approverlevel.Value);
                if (approver.value.length != 0 && userApproverLevel > 100000000) {
                    createApproveButton();
                    createDisapproveButton();
                }
            },
            error: function (xhr, textStatus, errorMessage) {
                console.log(errorMessage);
    ...
    //For Approval
    function createForApprovalButton() {
    ...
    function createApproveButton() {
        ...
        approveBtn.on('click', function (evt) {
            approveConfirmation.find('.confirmModal').on('click', function () {
                ...
                $('#gsc_approverguid').val(approverId);
                $("#UpdateButton").click();
    ...
    //Disapprove
    function createDisapproveButton() {
